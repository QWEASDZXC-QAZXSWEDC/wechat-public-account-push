export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxb237395ee193bb04",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "606a45c2078ce771e210a7676d2ccdf9",
  ...
  USERS: [
    {
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "gaXr-_3eUGMBmKlKPEif9IWafmZi-Jimf1Jz7CQYNMg",
      // 所在省份
      province: "河南",
      // 所在城市
      city: "新乡",
      ...
      openUrl: "weixinjianghan.github.io",
